...
const Species = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://44.196.192.232:3002/api/species/SpeciesCategories", formDataToSend, {
        headers: {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://44.196.192.232:3002/api/species/speciescategory/${selectedSpecies._id}`, formDataToSend, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
                ...
                {species.map((specie, index) => (
                  <CTableRow key={specie._id}>
                    ...
                    <CTableDataCell style={{ textAlign: "center" }}>
                      {specie.image && (
                        <img
                          src={`http://44.196.192.232:3002/${specie.image}`} // Update this path according to your API
                          alt={specie.name}
