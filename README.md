...
``` bash
# dev server with hot reload at http://18.209.197.35:3000
$ npm start 
```
...
Navigate to [http://18.209.197.35:3000](http://18.209.197.35:3000). The app will automatically reload if you change any of the source files.
